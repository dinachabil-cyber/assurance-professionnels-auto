  ...
  return (
    <section className="bg-gradient-to-r from-orange-400 to-orange-500 rounded-3xl p-12 text-center relative overflow-hidden max-w-4xl mx-auto my-16">
      <div className="relative">
        <div className="w-12 h-12 bg-dark/20 rounded-xl mx-auto mb-6 flex items-center justify-center">
          <i className="fas fa-car text-xl text-dark"></i>
        </div>
        <h2 className="text-2xl font-bold mb-4 text-dark">
          Devis RC pro pour professionnels de l&apos;automobile
        </h2>
        <p className="text-base mb-8 text-dark/80 max-w-xl mx-auto leading-relaxed">
