...
export default function ActivitySection() {
  return (
    <section className="py-20 md:py-28 bg-gradient-to-b from-gray-50 to-white" id="activites">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
          {activities.map((activity, index) => (
            <Link
              key={activity.label}
              to={activity.href}
              className="group relative bg-white rounded-2xl p-6 border border-gray-200 hover:border-orange-400 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1"
            ...
            >
              ...
              <div className="text-4xl mb-4 transform group-hover:scale-110 transition-transform">{activity.icon}</div>
        ...
        <div className="text-center mt-16">
          <Link
            to="/devis"
            className="inline-flex items-center gap-3 px-10 py-4 bg-gradient-to-r from-orange-500 to-orange-600 text-white rounded-2xl text-lg font-bold hover:from-orange-600 hover:to-orange-700 transition-all shadow-lg hover:shadow-2xl transform hover:-translate-y-1"
          >
