...
export default function HeroSection() {
  ...
  return (
    <section className="py-20 lg:py-32 bg-white hero-pattern relative overflow-hidden">
      <div className="absolute inset-0 scanlines-bg opacity-30"></div>
      <div className="absolute top-10 left-10 floating-animation">
        <i className="fas fa-car text-orange-400 text-6xl opacity-30"></i>
      </div>
      <div className="absolute bottom-10 right-10 floating-animation" style={{ animationDelay: '-2s' }}>
        <i className="fas fa-shield-alt text-orange-500 text-8xl opacity-25"></i>
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-start">
          <div className="slide-in-left">
            <div className="relative">
              <div className="w-full h-[500px] lg:h-[600px] bg-gradient-to-br from-orange-400 to-orange-500 rounded-3xl shadow-2xl overflow-hidden">
                <div className="absolute inset-0 bg-scanlines opacity-20"></div>
                <img
                  src="https://assurance-professionnels-auto.fr/image/photo.jpg"
          ...
          <div className="slide-in-right">
            <div className="bg-white rounded-2xl shadow-xl p-6 md:p-8 h-full flex flex-col overflow-y-auto">
