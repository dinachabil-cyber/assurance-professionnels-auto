...
use App\Models\NegociantsDevi;
use Illuminate\Http\Request;
use Illuminate\Http\JsonResponse;
use Illuminate\Support\Facades\Validator;
use Illuminate\Validation\Rule;

class NegociantsDevisController extends Controller
{
    public function store(Request $request): JsonResponse
    {
        ...
        $negociantsDevis = NegociantsDevi::create($validator->validated());

        return response()->json([
            'success' => true, 'message' => 'Votre demande de devis négociant a bien été enregistrée.', 'data' => $negociantsDevis,
        ], 201);
    }
}